...
void manual(){
   Serial.println("**Bienvenido al manual de uso**");
    delay(700);
    Serial.println("Aqui encontrara una guia rapida para entender el funcionamiento del circuito.");
    delay(700);
    Serial.print("- Cuando quiera ingresar un patron para que se muestre en los Leds, ");
    delay(700);
    Serial.println("debe tener en cuenta que debe");
    delay(700);
...
void loop(){
  ...
  Serial.println("0. Salida manual");
